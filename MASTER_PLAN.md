...
2. **Wiring-debt burn-down** (~4–6 d): T3/A3 GUI sliders (recipe path landed in `0610660`, GUI still
   ...
   (Mind the hand-ordered `_process_inputs` / `PROCESS_INPUT_KEYS` arg list.)
...
| R7 | **Melanin/hemoglobin skin decomposition** (moonshot) | ICA on log-RGB splits skin color into melanin + hemoglobin maps; attenuate hemoglobin only to fix redness/rosacea without graying, adjust melanin for principled tan/brighten. No consumer competitor has this. | ~2–3 wk | — | 📋 BACKLOG |
